...
const BasicButton = styled(Button)({ fontSize: 16, fontWeight: 500, fontFamily: 'Inter' })

const ButtonWithIcon = styled(Button)({
  fontSize: 16, fontWeight: 500, fontFamily: 'Inter', display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'center'
})
