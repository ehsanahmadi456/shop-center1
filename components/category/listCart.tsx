...
interface IProps {
  ...
  changeSort: (event: SelectChangeEvent) => void,
  changePagination: (event: React.ChangeEvent<unknown>, value: number) => void
}

const ListCart = ({ page, sort, listProducts, changeSort, changePagination }: IProps) => {
  return (
    <div className='w-[73%]'>
