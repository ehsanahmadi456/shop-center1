    ...
    <div className="flex flex-col justify-center items-start w-[48%]">
      ...
      <div className='flex flex-row items-center justify-start text-light-100 mt-5'>
        <div className='flex flex-row items-center'>
          ...
          <Body1 className='!font-poppins text-light-100'>{data?.star}</Body1>
        </div>
        <SubTitle2 className='!font-poppins text-light-100 ml-9'>{data?.review} review</SubTitle2>
        <SubTitle2 className='!font-poppins text-light-100 ml-9'>{data?.sold} sold</SubTitle2>
      </div>
      <div className='flex flex-row items-center justify-start my-8'>
        {data?.discount &&
          <Heading5 className='text-light-200 !font-poppins'>{data.discount} $</Heading5>
        }
        <SubTitle1
          className={`!font-poppins ${data?.discount ? 'line-through ml-7 text-dark-300' : 'text-light-200'}`}
        >{data?.price}$</SubTitle1>
      </div>
